<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Daerah</h1>
        <button onclick="adddaerah()" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Semua Daerah</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered tableUserAwal" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        foreach ($daerah as $d) {
                            $id = $d['id'];
                            echo "<tr>";
                            echo "<td>".$d['nama_daerah']."</td>";
                            echo '<td>

                                <button class="btn btn-primary btn-circle" onclick="editdaerah('.$id.')">
...
<div id="add_daerah" class="modal animated  fadeInUp" data-backdrop="static" role="dialog">
...
<script>
    ...
    function editdaerah(id) {
        console.log(id);
        toEdit();
        $.ajax({
            url: '{{ url("/admin_pu/daerah/edit") }}',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#id').val(response.id);
                $('#nama_daerah').val(response.nama_daerah);
    ...
    function update(id) {
        $.ajax({
            url: '{{ url("admin_pu/daerah/update") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form_data').serialize(),
            headers: {
