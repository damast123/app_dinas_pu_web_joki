            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-info">
                        <h3 class="text-white">Edit berita</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin_pu/berita/update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="gambar" id="gambar" value="{{$berita->gambar_berita}}">
